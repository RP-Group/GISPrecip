...
SOURCES = \
	__init__.py \
	GIS_Precip.py GIS_Precip_dialog.py

PLUGINNAME = GIS_Precip

PY_FILES = \
	__init__.py \
	GIS_Precip.py GIS_Precip_dialog.py

UI_FILES = GIS_Precip_dialog_base.ui
...
QGISDIR=C:\Users\gabri\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
